...
function useDragConstraints() {
  var constraintsRef = React.useRef(null);
  var onMeasureDragConstraints = React.useCallback(function () {
    return constraints;
  }, []);
  return {
...
var SheetScrollerContext = /*#__PURE__*/React.createContext(undefined);
function SheetScrollerContextProvider(_ref) {
  var children = _ref.children;
  var sheetContext = useSheetContext();
  var _React$useState = React.useState(!!sheetContext.disableDrag),
  ...
  return React.createElement(SheetScrollerContext.Provider, {
    value: {
...
var useSheetScrollerContext = function useSheetScrollerContext() {
  var context = React.useContext(SheetScrollerContext);
...
function preventScrollMobileSafari() {
  ...
  var restoreStyles = utils.chain(setStyle(document.documentElement, 'paddingRight', window.innerWidth - document.documentElement.clientWidth + "px"), setStyle(document.documentElement, 'overflow', 'hidden'), setStyle(document.body, 'marginTop', "-" + scrollY + "px"));
...
var _excluded = ["onOpenStart", "onOpenEnd", "onClose", "onCloseStart", "onCloseEnd", "onSnap", "children", "disableScrollLocking", "isOpen", "snapPoints", "rootId", "mountPoint", "style", "detent", "initialSnap", "disableDrag", "prefersReducedMotion", "tweenConfig"];
var Sheet = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var onOpenStart = _ref.onOpenStart,
    ...
    _ref$disableScrollLoc = _ref.disableScrollLocking,
    disableScrollLocking = _ref$disableScrollLoc === void 0 ? false : _ref$disableScrollLoc,
    isOpen = _ref.isOpen,
  ...
  var zIndex = framerMotion.useTransform(y, function (value) {
    return value >= windowHeight ? -1 : 9999999;
  });
  var visibility = framerMotion.useTransform(y, function (value) {
  ...
  usePreventScroll({
    isDisabled: disableScrollLocking === true || !isOpen
  });
  ...
  var sheet = React.createElement(SheetContext.Provider, {
    value: context
  }, React.createElement(framerMotion.motion.div, Object.assign({}, rest, {
    ref: ref,
    style: _extends({}, styles.wrapper, {
      zIndex: zIndex,
      visibility: visibility
    }, style)
  }), React.createElement(framerMotion.AnimatePresence, null, isOpen ? React.createElement(SheetScrollerContextProvider, null, React.Children.map(children, function (child, i) {
...
var SheetContent = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _useDragConstraints = useDragConstraints(),
    constraintsRef = _useDragConstraints.constraintsRef,
    onMeasureDragConstraints = _useDragConstraints.onMeasureDragConstraints;
...
var SheetScroller = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
